...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>JavaScript: Generating dynamic QR codes</title>
        <link rel="stylesheet" href="_css/styles.css">
        <script src="_scripts/qrcode.min.js"></script>
    </head>

    <body>
        <div id="infohead">
            <h1>JavaScript:<br>
                Generating dynamic QR codes</h1>
        </div>
        <div id="wrapper">
            <h3>Shh!... QR codes are sneakily and silently coming back! <br>But don't tell your competitors about it because they can be used to significantly boost your business... 
            <br>if only... you spend at least 5 minutes thinking about it... <br>
            Tip: Forget about static QR codes. To boost a business QR codes need to be generated dynamically, on the fly and you can (and should) put more information into those codes than just a simple link to a website. But that's the markeging guy in me speaking. </h3>
            <p>This little project here is merely just for technical basics.</p>
            <p>For the first QR code a PHP script dynamically grabs the URL of the current page.</p>
            <section>
                <div>
                    <img src="https://chart.googleapis.com/chart?chf=bg,s,ffffff&amp;cht=qr&amp;chs=120x120&amp;chl=<?php echo $url; ?>&amp;chld=|0" alt="QR code">
                </div>
                <p>In the following case, the QR code is generated using JavaScript. <br>
                    The script also grabs the URL dynamically from the current page and then uses it to create the QR code. </p>
                <div id="qrcode"></div>
            </section>
        </div>
        <!-- info icon -->
