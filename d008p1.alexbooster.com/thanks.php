...
<head>
    <meta charset="UTF-8">
    <title>YAML &amp; PHP: Write data into YAML file from form submission</title>
...
<body>
    <div id="infohead">
        <h1>YAML &amp; PHP:<br>
            Write data into YAML file from form submission</h1>
    </div>
    <div id="wrapper">
        <h3>Thank you for submitting your data! It will now be stored in <a href="data.yaml">this YAML file</a> for all eternity! How cool is that?!<br> :-)
            <br><br>
            P.S.: PHP works really well with YAML.
        </h3>
        <p>As <a href="https://github.com/mustangostang">Vlad Andersen</a> puts it:
            <br> &quot;
            <em><a href="http://www.yaml.org/">YAML</a> is an amazingly human friendly and strikingly versatile data serialization language which can be used for log files, config files, custom protocols, the works.</em>&quot;</p>
    </div>
