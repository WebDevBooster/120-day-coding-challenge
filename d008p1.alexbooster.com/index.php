...
<body>
    ...
    <div id="wrapper">
        <h3>If you submit some data in the form below, it will be stored in <a href="data.yaml">this YAML file</a>. Every form submission adds data to that YAML file.</h3>
        <form name="form1" method="post" action="">
            ...
            <p>
                <label for="coding">How much are you coding? (hours/day): </label>
                0
